 ...
 * @version   $Id: captcha-image.php,v 1.3 2005/06/05 05:19:16 dufuz Exp $
 ...
 */
$font_dir = $_SERVER['DOCUMENT_ROOT'] . '/inc/fonts/';
 ...
 * BASE IMAGE  =========================
 */
$im = imagecreate($image_width+10, $image_height+10);
...
imagejpeg($im, "images/captcha/".$_SESSION['imagefile'].".jpg", 100);
