...
s_help = "Striked text: [s]text[/s]  (alt+s)";
...
bbcode = new Array();
bbtags = new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[quote]','[/quote]','[code]','[/code]','[list]','[/list]','[list=]','[/list]','[img]','[/img]','[url]','[/url]','[center]','[/center]','[email]','[/email]','[s]','[/s]','[cut]','[/cut]');
imageTag = false;
...
function checkForm() {
        ...
        if (document.frm.text.value.length < 2) {
                formErrors = "Необходимо ввести сообщение.";
        }
